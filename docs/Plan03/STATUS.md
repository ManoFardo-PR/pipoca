...
- Gerado em: 2026-08-28T18:47:35.804Z · branch `onda-A-seguranca` · HEAD `5ecc07d`
- Progresso: **5/59** passos concluídos
...
## Onda A — Segurança e consentimento de IA · 2/6 · branch `onda-A-seguranca` · BUNDLE app + EDGE ×2 + SQL
...
| A3 | [Migração escrita (NÃO aplicada): RPC, índices, políticas](onda-A-seguranca/A3-migracao-rpc-indices-politicas.md) ∥ | […] em andamento | 2026-08-28 |  |

...
- Gerado em: 2026-09-03T11:41:14.980Z · branch `onda-D-bundle-app-admin` · HEAD `7eb64b5`
- Progresso: **39/59** passos concluídos
- Próximo passo: **D8** — CI: typecheck → testes → build → bundle-check → e2e ([abrir](onda-D-bundle-app-admin/D8-ci-workflow.md))
...
## Onda D — Bundle app + admin: sync, faxina, CI · 2/10 · branch `onda-D-bundle-app-admin` · BUNDLE app + admin

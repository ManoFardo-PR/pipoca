...
- Gerado em: 2026-09-01T17:08:46.677Z · branch `onda-C-bundle-app` · HEAD `582a06a`
- Progresso: **26/59** passos concluídos
- Próximo passo: **C2** — Estante de histórias digna ([abrir](onda-C-bundle-app/C2-estante-de-historias.md))
...
## Onda C — Bundle do app: histórias, avatars, cuidador · 2/13 · branch `onda-C-bundle-app` · BUNDLE app (+ admin)
